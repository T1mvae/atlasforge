...
function PwaBanner() {
  ...
  if (App.ui.card || App.ui.modal || App.ui.roadFrom || App.ui.geomDraw || App.ui.geomEdit ||
    (window.World && (World.preview || World.geoBusy || World.cutPreview || World.generating))) return null;
  if (P.updateReady) {
    return (
