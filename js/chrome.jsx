...
function TemplatesModal() {
  ...
  const cards = [
    ...
    { id: "agot", name: t("tmpl.agot.name"), desc: t("tmpl.agot.desc"), count: "~1870", feats: ["region-grid", "physical", "countries"] },
  ...
  const classic = [
    { id: "agot_duchies", name: t("tmpl.agotd.name"), desc: t("tmpl.agotd.desc"), count: "~615" },
    { id: "agot_kingdoms", name: t("tmpl.agotk.name"), desc: t("tmpl.agotk.desc"), count: "~45" },
    { id: "agot_baronies", name: t("tmpl.agotb.name"), desc: t("tmpl.agotb.desc"), count: "~10430" },
