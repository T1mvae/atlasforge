...
(function () {
  ...
  Actions.undo = function () {
    // a geography or province-cut preview on screen: undo means "not this" — drop it
    if (window.World && window.World.preview) { window.World.cancelGeography(); return; }
    if (window.World && window.World.cutPreview) { window.World.cancelCut(); return; }
  ...
  Actions.redo = function () {
    if (window.World && (window.World.preview || window.World.cutPreview)) return;
